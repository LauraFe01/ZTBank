...
<div align="center">
  ...
  <p>
    ...
    <a href="#🏛️-architettura"><strong>Architettura</strong></a> ·
    <a href="#📁-complete-project-structure"><strong>Complete Project Structure</strong></a> ·
    <a href="#📝-policy-implementate"><strong>Policy Implementate</strong></a> ·
    <a href="#🛠️-come-buildare-e-avviare"><strong>Come Buildare e Avviare</strong></a> ·
    <a href="#🔐-verifica-ssl-e-interazioni-pep"><strong>Verifica SSL e Interazioni PEP</strong></a> ·
    <a href="#⚙️-esecuzione-use-cases"><strong>Esecuzione Use Cases</strong></a> ·
